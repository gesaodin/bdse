...
func (a *Archivo) LeerTurco(ch chan []byte, tipo string) (bool, string) {
	posicionarchivo, fig := TipoArchivoTurco(tipo)
...
func TipoArchivoTurco(tipo string) (posicionarchivo int, fig string) {
